...
def calcVat(period):
    ...
    Returns a tuple: The first element is a list,
    one item for each VAT code:<br>
    'VAT code: ' The VAT code for this item<br>
    'Amount: ' The net sum for this VAT code<br>
    'Amount rounded: ' The rounded sum<br> 
    'VAT: ' The VAT sum <br>
    'VAT rounded: ' The rounded VAT sum<br>
    And the second element of the tuple is a date:<br>
    'lastDate: ' The last date of the period<br>
    """
    ...
    for v in vatL:
        ...
        sum= 0.0
        sumVat= 0.0
        if v.vatRate: rate= float(v.vatRate)/100.
        else: rate= 0.0
        for s in ourSplitL:
            if s.vat==code:
                if s.side== 'C':
...
def vatTransfer(period, pendOK, accSum, date):
    """
    ...
    'accSum:' List of calculated sums and VATs generated by calcVat()<br>
    'date:' The last date of the period<br>
